        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                button("7", Colors.grey.shade600, 1),
                button("8", Colors.grey.shade600, 1),
                button("9", Colors.grey.shade600, 1),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                button("4", Colors.grey.shade600, 1),
                button("5", Colors.grey.shade600, 1),
                button("6", Colors.grey.shade600, 1),
                button("-", Color(0xffff9800), 1
                )
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                button("1", Colors.grey.shade600, 1),
                button("2", Colors.grey.shade600, 1),
                button("3", Colors.grey.shade600, 1),
                button("+", Color(0xffff9800), 1
                )
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                button("0", Colors.grey.shade600, 0),
                button(".", Colors.grey.shade600, 1),
                button("=", Color(0xffff9800), 1
                )
              ],
            )
